...
theme.set_highlights = function(c)
  ...
  hl(0, '@comment.error', { fg = c.error, bg = 'NONE' })
  hl(0, '@comment.warning', { fg = c.warning, bg = 'NONE' })
  hl(0, '@comment.todo', { link = 'Title' })
  hl(0, '@comment.note', { fg = c.hint, bg = 'NONE' })
  ...
  hl(0, '@markup.strong', { fg = c.orange, bg = 'NONE', bold = true })
  hl(0, '@markup.italic', { fg = c.green, bg = 'NONE', italic = true })
  hl(0, '@markup.strikethrough', { fg = c.yellow, bg = 'NONE', strikethrough = true })
  ...
  hl(0, '@markup.environment', { fg = c.purple, bg = 'NONE' })
  hl(0, '@markup.link', { fg = c.cyan, bg = 'NONE' })
  hl(0, '@markup.link.label', { fg = c.cyan, bg = 'NONE' })
  hl(0, '@markup.link.url', { fg = c.comment, bg = 'NONE' })
  hl(0, '@markup.raw', { link = 'Comment' })
  hl(0, '@markup.raw.block', { link = 'Comment' })
  hl(0, '@markup.list', { fg = c.purple, bg = 'NONE' })
  hl(0, '@markup.list.checked', { fg = c.sign_add, bg = 'NONE' })
  ...
  hl(0, 'LspInlayHint', { fg = c.inlay_hint, bg = 'NONE' })
